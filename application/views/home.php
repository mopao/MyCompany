		      ...
		      <div class="row">
		        ...
		        <div class="col-sm ">
		        	...
		        	<ul class="list-carousel"> 
		        		...
		        		<li> <span class="glyphicon glyphicon-arrow-right"></span> Ergonomie de site web respect&eacute;e</li>
		        		<li> <span class="glyphicon glyphicon-arrow-right"></span> Web Design adaptatif</li>
		        		<li> <span class="glyphicon glyphicon-piggy-bank"> </span> Le tout dans le respect de votre budget.</li>
		        	</ul>
